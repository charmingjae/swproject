...
<%
	...
	String sql = "SELECT * FROM BOOKINFO WHERE SORT >= " + start + " AND SORT <= " + end + " ORDER BY SORT";
	...
	stat1 = conn.createStatement();
		...
		int sort = 1;
		String sqlSort = "SELECT tradenum FROM bookinfo ORDER BY tradenum DESC";
		rs = stat1.executeQuery(sqlSort);
		
		while(rs.next()){
			int stepNum = rs.getInt(1);
			String sqlColumnUpdate = "UPDATE bookinfo SET SORT = " + sort + " WHERE tradenum = " + stepNum;
