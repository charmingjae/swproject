...
<script>
	...
	function enterkey(keyWord) {
        if (window.event.keyCode == 13) {
             ...
             // 엔터키가 눌렸을 때 실행할 내용
             location.href='SearchSelProduct.jsp?selstat=판매중&keyWord='+keyWord;
        }
	}
</script>
...
<button type="button" onclick ="location.href='queryBook.jsp'" class="btn btn-primary pull-right">모든 책 보기</button>
	<div class="text-center">
		...
		<%
						...
						%>
							<li>
						      <a href="SearchSelProduct.jsp?pg=<%=startPage-1 %>" aria-label="Previous">
						...
						%>
									<li><a href="SearchSelProduct.jsp?pg=<%=i %>"><%=i %></a></li>
						<%
								}
							}
						%>
						...
						%>
							...
							<li>
						      <a href="SearchSelProduct.jsp?pg=<%=endPage+1 %>" aria-label="Next">
