 ...
 * Generated at: 2020-01-16 13:15:26 UTC
...
import simpleChain.PublicChain;
import simpleChain.PublicChain.*;
...
public final class product_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("jar:file:/Users/chaminjae/Desktop/swproject/board_project/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/board_project/WEB-INF/lib/standard.jar!/META-INF/c.tld", Long.valueOf(1090214156000L));
    _jspx_dependants.put("/WEB-INF/lib/standard.jar", Long.valueOf(1090272076000L));
    _jspx_dependants.put("jar:file:/Users/chaminjae/Desktop/swproject/board_project/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/board_project/WEB-INF/lib/standard.jar!/META-INF/fmt.tld", Long.valueOf(1090214156000L));
  }
  ...
  static {
    ...
    _jspx_imports_packages.add("simpleChain.PublicChain");
    _jspx_imports_packages.add("javax.servlet.jsp");
    _jspx_imports_classes = new java.util.HashSet<>();
    _jspx_imports_classes.add("simpleChain.Block");
    _jspx_imports_classes.add("simpleChain.PublicChain");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      out.write("<style type=\"text/css\"> /* css */\n");
      ...
      out.write("</style>\n");
      out.write("\n");
      out.write("<script src=\"https://code.jquery.com/jquery-3.4.1.js\"></script> <!--  0924 append -->\n");
      ...
      out.write("           \n");
      out.write("          blockInfo.product = form.proname.value;\n");
      out.write("          blockInfo.nation = form.proloc.value;\n");
      ...
      out.write("          console.log(jsonInfo); //브라우저 f12개발자 모드에서 console로 확인 가능\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("function generateBlock(){ //최초 블록 생성 함수\n");
      out.write("\tlocation.href=\"./generateBlock.jsp\";\n");
      out.write("}\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\tvar form = document.chkform;\n");
      out.write("\tif(confirm(\"상태를 변경하시겠습니까? index number : \")){\n");
      out.write("\t\tform.submit();\n");
      out.write("\t}\n");
      out.write("\telse{\n");
      out.write("\t\treturn;\n");
      ...
      out.write("\t\t\t\t \t<table border = 0 width=\"15%\" cellpadding=\"0\" cellspacing=\"0\" style=\"margin:auto; text-align:center\">\n");
      out.write("\t\t\t\t \t\t<tr>\n");
      out.write("\t\t\t\t \t\t\t<td>제품명</td>\n");
      out.write("\t\t\t\t \t\t\t<td>\n");
      ...
      out.write("\t  \t\t<tr>\n");
      out.write("\t   \t\t\t<td>\n");
      out.write("\t   \t\t\t\t<input type=button value=\"등록\" OnClick =\"generateBlock();\">\n");
      out.write("\t   \t\t\t\t<!-- <input type=button value=\"수정\" OnClick = \"javascript:statusChg();\"> -->\n");
      out.write("\t   \t\t\t\t<!-- <input type=button value=\"json append\" id=\"checkJson\"> -->\n");
      out.write("\t   \t\t\t\t<!-- input type=button value=\"TESTTEST\" id=\"selectBtn\"> -->\n");
      out.write("\t   \t\t\t\t<!-- <button type=\"button\" id=\"selectBtn\">선택</button> -->\n");
      out.write("\t   \t\t\t\t<input type=\"button\" value=\"거래내역 추가\" Onclick = \"javascript:writeCheck();\">\n");
      out.write("\t   \t\t\t\t<!-- <button type=\"button\" value=\"최초 블록 생성\" Onclick = \"javascript:generateBlock();\"> 최초 블록 생성 </button> -->\n");
      out.write("\t   \t\t\t</td>\n");
      out.write("\t  \t\t</tr>\n");
      ...
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t\t<form name=chkform method=post action=\"edit.jsp\">\n");
      out.write("\t\t\n");
      out.write("\t\t<table width=\"1200px\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"margin:auto; text-align:center\" class=\"type11\">\n");
      out.write("\t\t\n");
      out.write("\t\t\t");
      ...
      out.write("\t\t\t\t\t<td colspan = \"6\"> 등록된 상품이 없습니다.</td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t");
      ...
      out.write("\t\n");
      out.write("  \t\t\t\t<tr>\n");
      out.write("  \t\t\t\t\t<td><input type=\"radio\" name=\"user_CheckBox\" ></td>\n");
      out.write("  \t\t\t\t\t<td>");
      out.print( idx );
      out.write("</td>\n");
      out.write("  \t\t\t\t\t<td>");
      ...
      out.write("  \t\t\t\t<tr><td colspan=\"6\" height=\"5\"></td></tr>\n");
      out.write("  \t\t\t\t<tr>\n");
      ...
      out.write("\t\t\t</table>\n");
      out.write("\t\t\t<br/>\n");
      out.write("\t\t\t<div class=\"col-lg-12\" id=\"ex3_Result2\" style=\"width:100%; text-align:center;\"></div> \n");
      out.write("\t\t\t<br/><br/>\n");
      out.write("\t\t\t<div align=\"center\">\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"idx_t\" value=\"\"/>\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"proname_t\" value=\"\"/>\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"nation_t\" value=\"\"/>\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"count_t\" value=\"\"/>\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"date_t\" value=\"\"/>\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"status_t\" value=\"\"/>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t</form>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t<img style =\"display: block; margin: 0px auto;\" src=\"https://djbooth.net/.image/c_limit%2Ccs_srgb%2Cq_auto:good%2Cw_700/MTU1ODQ4ODEwMjg5OTY0NDg4/asap-rocky-testing-album-review.webp\">\n");
      out.write("\t\t\t");
      ...
      out.write("\n");
      out.write("\t<script>\n");
      out.write("\t\t// 상단 선택버튼 클릭시 체크된 Row의 값을 가져온다.\n");
      ...
      out.write("\t\t\tvar checkbox = $(\"input[name=user_CheckBox]:checked\");\n");
      out.write("\t\t\t\n");
      ...
      out.write("\t\t\t\tvar idx = td.eq(1).text()\n");
      out.write("\t\t\t\tvar proname = td.eq(2).text();\n");
      out.write("\t\t\t\tvar nation = td.eq(3).text();\n");
      out.write("\t\t\t\tvar count = td.eq(4).text();\n");
      out.write("\t\t\t\tvar date = td.eq(5).text();\n");
      out.write("\t\t\t\tvar status = td.eq(6).text();\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t/* Block.product = proname;\n");
      out.write("\t\t\t\tBlock.nation = nation;\n");
      out.write("\t\t\t\tBlock.amount = count; */\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t// 가져온 값을 배열에 담는다.\n");
      out.write("\t\t\t\ttdArr.push(idx);\n");
      out.write("\t\t\t\ttdArr.push(proname);\n");
      out.write("\t\t\t\ttdArr.push(nation);\n");
      out.write("\t\t\t\ttdArr.push(count);\n");
      out.write("\t\t\t\ttdArr.push(date);\n");
      out.write("\t\t\t\ttdArr.push(status);\n");
      ...
      out.write("\t\t\t});\n");
      out.write("\t\t\tvar str = tdArr.join(', ');\n");
      out.write("\t\t\t//$(\"#ex3_Result1\").html(\" * 체크된 Row의 모든 데이터 = \"+rowData);\t\n");
      out.write("\t\t\t$(\"#ex3_Result2\").html(str);\t\n");
      out.write("\t\t\t$('input[name=idx_t]').attr('value',tdArr[0]);\n");
      out.write("\t\t\t$('input[name=proname_t]').attr('value',tdArr[1]);\n");
      out.write("\t\t\t$('input[name=nation_t]').attr('value',tdArr[2]);\n");
      out.write("\t\t\t$('input[name=count_t]').attr('value',tdArr[3]);\n");
      out.write("\t\t\t$('input[name=date_t]').attr('value',tdArr[4]);\n");
      out.write("\t\t\t$('input[name=status_t]').attr('value',jQuery.trim(tdArr[5]));\n");
      out.write("\t\t});\n");
      out.write("\t</script>\n");
      out.write("</html>\n");
      out.write("\n");
